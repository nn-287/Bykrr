...
class CustomerController extends Controller
{
    public function customer_list()
    {
        ...
        return view('merchant-views.customer.list', compact('customers'));
    }
    ...
    public function search(Request $request){
        ...
        return response()->json([
            'view'=>view('merchant-views.customer.partials._table',compact('customers'))->render()
        ]);
    }
    ...
    public function view($id)
    {
        ...
        if (isset($customer)) {
            ...
            return view('merchant-views.customer.customer-view', compact('customer', 'orders','serviceData', 'user_meals'));
        }

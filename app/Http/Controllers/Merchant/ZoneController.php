...
class ZoneController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('merchant-views.zone.index', compact('zones'));
    }
    ...
    public function list()
    {
        ...
        return view('merchant-views.zone.list', compact(['zones']));
    }
    ...
    public function edit($id)
    {
        ...
        return view('merchant-views.zone.edit', compact(['zone','area']));
    }
    ...
    public function zone_settings($id)
    {
        ...
        return view('merchant-views.zone.settings', compact('zone'));
    }
    ...
    //         'view'=>view('merchant-views.zone.partials._table',compact('zones'))->render(),
    //         'total'=>$zones->count()
    //     ]);
    // }

        ...
        <td>
            @if($order->customer)
                <a class="text-body text-capitalize"
                   href="{{route('merchant.customer.view',[$order['user_id']])}}">{{$order->customer['f_name'].' '.$order->customer['l_name']}}</a>
            @else
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item"
                       href="{{route('merchant.orders.details',['id'=>$order['id']])}}"><i
                            class="tio-visible"></i> {{trans('messages.view')}}</a>
                    <a class="dropdown-item" target="_blank"
                       href="{{route('merchant.orders.generate-invoice',[$order['id']])}}"><i

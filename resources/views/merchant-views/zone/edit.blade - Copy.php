...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row gx-2 gx-lg-3">
            ...
            <form action="{{route('merchant.zone.update', [$zone->id])}}" method="post" enctype="multipart/form-data">
...
<script>
    ...
    <script>
        ...
        {
            $.get({
                url: '{{route('merchant.zone.zoneCoordinates')}}',
                dataType: 'json',

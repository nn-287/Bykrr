...
{{--  --}}
    <div class="content container-fluid">
        ...
        <!-- End Page Header -->
        <form action="{{ route('merchant.zone.zone_settings_update', $zone->id) }}" method="post" class="card p-0 border-0 shadow--card">
            @csrf
            ...
            <!-- Incentive Item -->
                <div class="__bg-F8F9FC-card">
                    ...
                    <div class="d-none" id="show_incentive">
                        <!-- Incentive Item -->
                        <form action="{{ route('merchant.zone.incentive.store', ['zone_id' => $zone->id]) }}"
                            method="POST">
                            @csrf
                    ...
                    <div class="single-item-slider owl-carousel">
                        ...
                        <div class="item">
                            <div class="max-544 mx-auto mb-20 text-center">
                                ...
                                <a  href="{{ route('merchant.delivery-man.incentive')  }}" type="button"  class="btn btn--primary">{{translate('View_Incentive_Requests')}}</a>
                            </div>
                        </div>
                    </div>

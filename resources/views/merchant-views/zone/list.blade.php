            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <a href="{{route('merchant.zone.home')}}" class="btn btn-primary pull-right"><i
                                ...
                                <tr>
                                    ...
                                    @if($zone['status']==1)
                                            <div style="padding: 10px;border: 1px solid;cursor: pointer"
                                                 onclick="location.href='{{route('merchant.zone.status',[$zone['id'],0])}}'">
                                                <span class="legend-indicator bg-success"></span>Active
                                            </div>
                                        @else
                                            <div style="padding: 10px;border: 1px solid;cursor: pointer"
                                                 onclick="location.href='{{route('merchant.zone.status',[$zone['id'],1])}}'">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item"
                                                   href="{{route('merchant.zone.edit',[$zone['id']])}}">{{trans('messages.edit')}}</a>
